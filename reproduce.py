...
def normalized_drift(pred, target, still, temperatures, attraction_only=False):
    ...
    for tau in temperatures:
        ...
        field = vpos if attraction_only else vpos - vneg
        ...
        with torch.autocast("cuda", dtype=torch.bfloat16):
            if cfg["objective"] == "mse":
                ...
                field = normalized_drift(
                    ...
                    cfg.get("drift_attraction_only", False),
                )
